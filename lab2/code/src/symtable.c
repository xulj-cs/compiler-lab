...
static int searchSymTable_f(const char *name,ParaList_Ret paraList_ret,int lineno){
...
static int insertSymTable(const char *name,int kind,void * info,int func_line){
